...
{
    /// <summary>Contiene los métodos de acceso a datos de la clase 'Documento_Lin'.</summary>
    public partial class Documento_Lin
    {
        ...
        static public int Actualizar(Entity.Documento_Lin Item, Cursor oCursor)
        {
        ...
        static public int Eliminar(Entity.Documento_Lin Item, Cursor oCursor)
        {
            SqlCommand oComando = oCursor.ObtenerComando(Contexto.CnControlPresupuesto);
            string Esquema = Galeria.Conexiones[(int)Contexto.CnControlPresupuesto].EsquemaDefecto;
        ...
        static public List<Entity.Documento_Lin.Listar> Listar(Entity.Documento_Lin Item, Cursor oCursor)
        {
            var ResultSet = new List<Entity.Documento_Lin.Listar>();
            SqlCommand oComando = oCursor.ObtenerComando(Contexto.CnControlPresupuesto);
            string Esquema = Galeria.Conexiones[(int)Contexto.CnControlPresupuesto].EsquemaDefecto;
            ...
            try
            {
                ...
                using (SqlDataReader oLector = oComando.ExecuteReader())
                {
                    while (oLector.Read())
                    {
                        var LItem = new Entity.Documento_Lin.Listar();
